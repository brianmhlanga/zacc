-- AlterTable
ALTER TABLE `contact_submissions` ADD COLUMN `category` ENUM('GENERAL', 'COMPLAINT', 'COMPLIMENT', 'INQUIRY', 'OTHER') NOT NULL DEFAULT 'GENERAL';

-- AlterTable
ALTER TABLE `gallery_images` ADD COLUMN `showTitle` BOOLEAN NOT NULL DEFAULT true;

-- AlterTable
ALTER TABLE `page_content` ADD COLUMN `isLocked` BOOLEAN NOT NULL DEFAULT false;

-- AlterTable
ALTER TABLE `statistics` ADD COLUMN `year` INTEGER NOT NULL DEFAULT 2026;
