        ...
        <div class="flex items-center gap-6">
          <div class="hidden sm:flex items-center gap-2 text-white">
            <a
              href="#"
              aria-label="X"
              class="inline-flex h-8 w-8 items-center justify-center rounded-full border border-zaccGold/70 hover:border-zaccGold hover:bg-zaccGold/20 transition"
            >
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="h-4 w-4 text-zaccGold">
                <path
