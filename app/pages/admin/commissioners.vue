  ...
  <NuxtLayout name="dashboard">
    <div>
      ...
      <div class="mb-6 flex items-center justify-between">
        <div>
          <h1 class="text-3xl font-extrabold text-zaccBlack">Our Team Management</h1>
          <p class="mt-2 text-gray-600">Manage team members and commissioners</p>
        </div>
        <Button
          ...
          >
            <template #header>
              <div class="flex items-center justify-between mb-4">
                <span class="text-xl font-semibold text-zaccBlack">All Team Members</span>
      ...
      <Dialog
        ...
        :header="isEditMode ? 'Edit Team Member' : 'Create New Team Member'"
        :modal="true"
...
useHead({
  title: 'Our Team Management - ZACC CMS',
  meta: [
    {
      name: 'description',
      content: 'Manage team members and commissioners'
    }
  ]
})
...
const fetchCommissioners = async () => {
  ...
  try {
    ...
    toast.add({
      severity: 'error',
      summary: 'Error',
      detail: error.data?.message || 'Failed to load team members',
      life: 3000
    })
  } finally {
    loading.value = false
...
const handleSubmit = async () => {
  ...
  try {
    ...
    toast.add({
      severity: 'error',
      summary: 'Error',
      detail: error.data?.message || 'Failed to save team member',
      life: 3000
    })
  } finally {
    ...
    accept: async () => {
      try {
        ...
        toast.add({
          severity: 'error',
          summary: 'Error',
          detail: error.data?.message || 'Failed to delete team member',
          life: 3000
        })
      }
    }
