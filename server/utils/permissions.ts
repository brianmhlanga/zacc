...
export const ADMIN_PERMISSION_MODULES = [
  ...
  { key: 'jobs', label: 'Vacancies' },
  { key: 'applications', label: 'Applications & shortlisting' },
  { key: 'panel_review', label: 'Panel review' },
  { key: 'recruitment_config', label: 'Recruitment settings' },
  { key: 'recruitment_reports', label: 'Recruitment reports' },
